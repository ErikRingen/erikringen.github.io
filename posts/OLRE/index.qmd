...
Where log(population) has been standardized to have zero mean and unit variance. Then, we will perform posterior predictive checks using some off-the-shelf convenience functions.
